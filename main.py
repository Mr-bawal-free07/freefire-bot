            ...
            while True:
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = f'Hi! I am a bot from IRFAN ENGINE'
...
async def MaiiiinE():
    ...
    Uid , Pw = '4288564845','24635FB31231EE227821C2704D68093B9484C0B1769E8A480831031B26495B96'
    ...
    print(render('IRFAN ENGINE', colors=['white', 'red'], align='center'))
    print(f" - BoT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | IRFAN ENGINE ! (:")    
    print(f" - SCRIPT BY > IRFAN ENGINE ! (:")    
