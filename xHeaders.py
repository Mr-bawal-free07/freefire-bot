...
def GeT_Name(uid , Token):
    ...
    url = "https://client.ind.freefiremobile.com/GetPlayerPersonalShow" # <-- UPDATED URL
    headers = {
        'X-Unity-Version': '2018.4.11f1',
        'ReleaseVersion': 'OB51',
        'Content-Type': 'application/x-www-form-urlencoded',
        ...
        'Host': 'client.ind.freefiremobile.com', # <-- UPDATED HOST
        'Connection': 'Keep-Alive',
        'Accept-Encoding': 'gzip'
    }
...
def DeLet_Uid(id , Tok):
    ...
    url = 'https://client.ind.freefiremobile.com/RemoveFriend' # <-- UPDATED URL
    headers = {
        'X-Unity-Version': '2018.4.11f1',
        'ReleaseVersion': 'OB51',
        'Content-Type': 'application/x-www-form-urlencoded',
